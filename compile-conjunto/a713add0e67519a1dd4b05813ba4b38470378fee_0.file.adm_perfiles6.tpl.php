<?php
/* Smarty version 3.1.32, created on 2019-04-29 20:37:10
  from 'C:\xampp\tpl-conjunto\adm_perfiles6.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5cc744562481f3_50658699',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a713add0e67519a1dd4b05813ba4b38470378fee' => 
    array (
      0 => 'C:\\xampp\\tpl-conjunto\\adm_perfiles6.tpl',
      1 => 1556560818,
      2 => 'file',
    ),
  ),
...
function content_5cc744562481f3_50658699 (Smarty_Internal_Template $_smarty_tpl) {
...
<table id="tabla1" class="display" style="width:100%">
    ...
    <tbody>
  <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['tabla_perfiles_2']->value, 'fila');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['fila']->value) {
?>
  <tr>
    <td style="text-align: center;">
      <a href="#" title="Editar" data-toggle="modal" data-target="#myModal"  onclick="return editar(<?php echo $_smarty_tpl->tpl_vars['fila']->value['id_perfil'];?>
,this.parentNode.parentNode.id);"><i class="fa fa-edit" style="font-size:24px; color:blue;"></i></a>
    ...
    <td style="text-align: center;">
      <a href="#" title="Eliminar" data-toggle="modal" data-target="#myModal" onclick="return eliminar(<?php echo $_smarty_tpl->tpl_vars['fila']->value['id_perfil'];?>
 ...
 function eliminar(argument,obj) {
  ...
  $.post("trae_perfil.php",
    ...
    function(data, status){ // Callback
      objson = JSON.parse(data);
      alert(data);
      $("#id_perfil").val("").attr("readonly", true);
    ...
    function(data, status) { // Callback
        ...
        switch ($("#crud").val()) {
          case 'u': // Update
            ...
            $("#id_perfil").val(),
            $("#nombre_perfil").val(),
            '<a href="#" data-toggle="modal" data-target="#myModal" onclick="return eliminar('+$("#id_perfil").val()+',this.parentNode.parentNode.id);"><i class="fa fa-trash-o" style="font-size:24px;color:red;"></i></a>')).draw( false );
