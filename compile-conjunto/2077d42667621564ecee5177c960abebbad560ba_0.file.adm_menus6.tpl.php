<?php
/* Smarty version 3.1.32, created on 2019-02-16 23:58:02
  from 'C:\xampp\tpl-conjunto\adm_menus6.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5c68957aea6e06_22711036',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2077d42667621564ecee5177c960abebbad560ba' => 
    array (
      0 => 'C:\\xampp\\tpl-conjunto\\adm_menus6.tpl',
      1 => 1548517808,
      2 => 'file',
    ),
  ),
...
function content_5c68957aea6e06_22711036 (Smarty_Internal_Template $_smarty_tpl) {
...
<table id="tabla1" class="display" style="width:100%">
    ...
    <tbody>
	<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['tabla_menus_2']->value, 'fila');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['fila']->value) {
?>
	<tr>
		<td style="text-align: center;">
			<a href="#" title="Editar" data-toggle="modal" data-target="#myModal"  onclick="return editar(<?php echo $_smarty_tpl->tpl_vars['fila']->value['id_menu'];?>
...
<?php echo '<script'; ?>
 ...
 function editar(argument,obj) {
    ...
    function(data, status) { // Callback
        ...
        $("#modulo").val(objson.modulo).attr("readonly", false);
 ...
 function eliminar(argument,obj) {
    ...
    function(data, status){ // Callback
        ...
        $("#modulo").val(objson.modulo).attr("readonly", true);
 ...
 function adicionar() {
    ...
    function(data, status){ // Callback
      ...
      $("#modulo").val("").attr("readonly", false);
    ...
    function(data, status) { // Callback
        ...
        switch ($("#crud").val()) {
          case 'u': // Update
            ...
            $("#icono").val(),
            $("#url").val(),
            '<a href="#" title="Eliminar" data-toggle="modal" data-target="#myModal" onclick="return eliminar('+$("#id_menu").val()+',this.parentNode.parentNode.id);"><i class="fa fa-trash-o" style="font-size:24px;color:red;"></i></a>')).draw( false );
          ...
          case 'c': // Create
            ...
            var uu = t.row.add( [
              ...
              $("#icono").val(),
              $("#url").val(),
              '<a href="#" data-toggle="modal" data-target="#myModal" onclick="return eliminar('+objson.id_menu+',this.parentNode.parentNode.id);"><i class="fa fa-trash-o" style="font-size:24px;color:red;"></i></a>'
            ] ).draw( false );
